...
CODIS_SERVER_PID_FILE={{ codis_server_workdir }}-{{ codis_server_port }}/redis_{{ codis_server_port }}.pid

CODIS_SERVER_LOG_FILE={{ codis_server_workdir }}-{{ codis_server_port }}/redis_{{ codis_server_port }}.log
CODIS_SERVER_DAEMON_FILE=$CODIS_LOG_DIR/codis-server.out

CODIS_SERVER_CONF_FILE=$CODIS_CONF_DIR/redis-{{ codis_server_port }}.conf
